...
class TestDataInitializer {
    ...
    fun initialize() {
        ...
        val teamiOS = teamService.create(leo, "Team Leo + Elo", "Die fleißigen iOS Tester", eventMunich, null, null)
        ...
        val team1 = teamService.create(participant1, "Erstes Team", "Geile Sache", eventMunich, null, null)
        ...
        val team2 = teamService.create(participant3, "Zweites Team", "Immer noch geil", eventBerlin, null, null)
