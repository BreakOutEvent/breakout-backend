...
class TestTeamEndpoint : IntegrationTest() {
    ...
    fun testGetTeamById() {
        ...
        val response = mockMvc.perform (request)
                ...
                .andExpect(jsonPath("$.invoiceId").exists())
                .andExpect(jsonPath("$.description").exists())
                .andExpect(jsonPath("$.distance.linear_distance").exists())
                .andExpect(jsonPath("$.distance.actual_distance").exists())
                .andExpect(jsonPath("$.donateSum.sponsoring_sum").exists())
                .andExpect(jsonPath("$.donateSum.challenges_with_proof_sum").exists())
                .andExpect(jsonPath("$.donateSum.challenges_accepted_proof_sum").exists())
                .andExpect(jsonPath("$.donateSum.full_sum").exists())
                .andExpect(jsonPath("$.members").exists())
    ...
    fun testGetTeamsByEvent() {
        ...
        val response = mockMvc.perform (request)
                ...
                .andExpect(jsonPath("$[0].distance.linear_distance").exists())
                .andExpect(jsonPath("$[0].distance.actual_distance").exists())
                .andExpect(jsonPath("$[0].donateSum.sponsoring_sum").exists())
                .andExpect(jsonPath("$[0].donateSum.challenges_with_proof_sum").exists())
                .andExpect(jsonPath("$[0].donateSum.challenges_accepted_proof_sum").exists())
                .andExpect(jsonPath("$[0].donateSum.full_sum").exists())
